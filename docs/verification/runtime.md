...
| `remote_sha_parity` | `PASS` | Local `HEAD`, `origin/main`, and the `v0.1.2` tag all resolve to `98fc6e32`. The tag is annotated and its dereferenced target matches the branch head on the remote. |
