...
```bash
node scripts/bump-plugin.mjs image-factory patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs image-factory minor   # 新功能
node scripts/bump-plugin.mjs image-factory major   # 破坏性变更
```
